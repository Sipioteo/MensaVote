import { c as create_ssr_component, s as setContext, v as validate_component, m as missing_component } from './chunks/index2-0a3d7029.js';
import { r as readable, w as writable } from './chunks/index-b5cc99b4.js';
...
async function respond(request, options2, manifest, state) {
  ...
  const event = {
    ...
    getClientAddress: state.getClientAddress || (() => {
      throw new Error(
        `${"@macfja/svelte-adapter-multi"} does not specify getClientAddress. Please raise an issue`
      );
    }),
    locals: {},
    params,
